...
2026-08-09T05:25:00Z | codex | HARDENING-74 | SECURITY_FINDING | readPrefix_trusted_provider_Range_and_materialized_response_body_without_an_independent_ceiling; nonconforming_or_compromised_provider_could_bypass_prefix_memory_budget
...
2026-08-09T07:02:00Z | codex | HARDENING-80 | RELEASE_REASSESSMENT | production-readiness-check exit1 with 16 unresolved requirements; the new hosted worker sandbox attestation is explicitly reported as missing alongside external/legal blockers.
2026-08-09T07:10:00Z | codex | HARDENING-81 | DOCS_HARDENING | PRODUCTION_READINESS.md was stale (claimed MAXIMUM_ENGINEERING_COMPLETE and 15 blockers); replaced with evidence-aligned continuation status, current local test counts, 16-blocker preflight result, hosted sandbox gate, and remaining fulfillment/native-auth work.
2026-08-09T07:15:00Z | codex | HARDENING-82 | CONFIG_HARDENING | scripts/generate-local-env.sh now emits WORKER_SANDBOX_EVIDENCE_FILE so generated ignored environments remain synchronized with the required preflight table; shell syntax, format, and secret scan passed.
2026-08-09T07:22:00Z | codex | HARDENING-83 | CI_HARDENING | release.yml now accepts WORKER_SANDBOX_EVIDENCE as an ephemeral runner secret, writes it only under RUNNER_TEMP, and injects WORKER_SANDBOX_EVIDENCE_FILE into the preflight environment; missing or empty evidence remains fail-closed.
2026-08-09T07:24:00Z | codex | HARDENING-83 | INVENTORY_UPDATE | DEFERRED_EXTERNALS EXT-023 now records both the local evidence path and the release-CI secret name, with exact probe and validation commands.
2026-08-09T07:32:00Z | codex | HARDENING-84 | CI_HARDENING | release.yml now proves configured external credentials with preflight first, then rewrites only local DB/Redis/R2/OTLP endpoints to generated disposable Compose services before full verify; this prevents remote credentials from being sent to local containers and enables real CI integration/E2E coverage.
2026-08-09T07:34:00Z | codex | HARDENING-84 | DOCS_HARDENING | PREFLIGHT.md now documents the ephemeral CI mapping for approval and sandbox evidence secrets; no evidence values are committed.
2026-08-09T07:38:00Z | codex | HARDENING-85 | CI_HARDENING | release.yml installs the Compose teardown trap before dependency startup or worker image build, covering all later failure paths; workflow YAML, format, and secret checks remain green.
2026-08-09T07:55:00Z | codex | HARDENING-86 | SECURITY_HARDENING | Timed media tools now run in a dedicated POSIX process group and timeout escalation terminates the group before the direct-child fallback; Windows remains safe via direct-child signaling. The process-group regression and media suite pass.
2026-08-09T07:56:00Z | codex | HARDENING-86 | LOCAL_VERIFICATION | typecheck, format-check, unit 27 files/105 tests, integration 13 files/41 tests, E2E 3 files/11 tests, build, security-check, secret-scan, dependency-audit, reality-gate, smoke, performance (100 requests, p95 0.99ms), backup/restore, and all sixteen live-fire proofs passed. Restore sentinel: schema_migrations=12. Production readiness remains fail-closed on the documented external/legal requirements.
2026-08-09T08:25:00Z | codex | HARDENING-89 | SUPPLY_CHAIN_HARDENING | Verify/release workflow actions are pinned to reviewed immutable commit SHAs; the Node multi-stage Docker base is pinned to OCI digest sha256:36ae19f59c91f3303c7a648f07493fe14c4bd91320ac8d898416327bacf1bbfa; security checks reject mutable action refs and undigested Node base lines.
2026-08-09T08:27:00Z | codex | HARDENING-89 | LOCAL_VERIFICATION | workflow YAML, security-check, typecheck, format-check, API image build, and worker image build passed; production external/legal gates unchanged.
2026-08-09T08:32:00Z | codex | HARDENING-90 | DOCS_HARDENING | PRODUCTION_READINESS.md now reports the current 27-file/105-test unit count and records the immutable CI/image supply-chain gate; no readiness status was promoted.
2026-08-09T08:42:00Z | codex | HARDENING-91 | OPERATIONS_HARDENING | local-services-check.sh now falls back to real Mailpit and OTEL health probes over the Compose internal network when host forwarding is absent; host probes remain preferred and no synthetic success path was added.
2026-08-09T08:44:00Z | codex | HARDENING-91 | LOCAL_VERIFICATION | shell syntax, local-services-check (internal fallback), security-check, and format-check passed; the production gate remains fail-closed.
2026-08-09T08:50:00Z | codex | HARDENING-92 | SECURITY_SCAN | standard_scan_f36d18e7 completed against revision 5d816e1; one high-confidence hosted-worker-sandbox finding recorded; local Compose controls are not treated as hosted proof.
2026-08-09T08:52:00Z | codex | HARDENING-92 | FIX_APPLIED | worker-runtime now exposes loopback-only /health/live and /health/ready endpoints; readiness follows Redis dependency state and is cleared during shutdown, repairing the previously invalid inherited Docker healthcheck without creating a public listener.
2026-08-09T08:54:00Z | codex | HARDENING-92 | LOCAL_VERIFICATION | worker source formatting, repository typecheck, lint, and format-check passed; production-readiness remains fail-closed with the same 16 external/legal/evidence requirements.
2026-08-09T09:03:00Z | codex | HARDENING-93 | FINDING | rebuilt worker image restarted under the read-only Compose profile because Corepack attempted to create /home/node/.cache/node/corepack/v1; this was an actual image-startup defect, not a healthcheck-only observation.
2026-08-09T09:05:00Z | codex | HARDENING-93 | FIX_APPLIED | Docker runtime-base now preinstalls pinned pnpm 10.13.1 into image-owned COREPACK_HOME=/usr/local/share/corepack and grants read access to node; no runtime package-manager download or writable home cache is required.
2026-08-09T09:12:00Z | codex | HARDENING-94 | FINDING | rebuilt worker reached application startup after the Corepack fix but failed the shared production config schema because CORS_ALLOWED_ORIGINS was unset; the worker has no cross-origin API surface, but the schema is intentionally fail-closed.
2026-08-09T09:14:00Z | codex | HARDENING-94 | FIX_APPLIED | local Compose and fly.worker.toml now provide only the reserved non-routable HTTPS origin https://worker.invalid for the worker; API/web origin policies are unchanged.
2026-08-09T09:22:00Z | codex | HARDENING-95 | FINDING | with Corepack and CORS fixed, the local worker rehearsal reached the storage guard and rejected its intentional internal HTTP MinIO endpoint because Compose incorrectly labeled the profile production.
2026-08-09T09:24:00Z | codex | HARDENING-95 | FIX_APPLIED | opt-in Compose worker profile now uses NODE_ENV=development; hosted fly.worker.toml remains production and still requires HTTPS object storage.
2026-08-09T09:31:00Z | codex | HARDENING-95 | LOCAL_VERIFICATION | rebuilt worker image started in the real internal Compose stack and reported `Up (healthy)` with the read-only filesystem; Compose config, security-check, typecheck, format-check, lint, secret-scan, and unit 27 files/105 tests passed. Worker stopped after probe; no production effect invoked.
2026-08-09T09:45:00Z | codex | HARDENING-96 | LOCAL_VERIFICATION | internal integration 13 files/41 tests, E2E 3 files/11 tests, all 16 live-fire proofs, network-aware local-services-check, and performance smoke (100 requests, p95 0.59ms) passed; fresh encrypted backup/restore passed with schema_migrations=12.
2026-08-09T10:02:00Z | codex | HARDENING-97 | SECURITY_HARDENING | generated archive resource GET/POST routes now explicitly revalidate current archive membership after permission checks; a partially configured authority boundary can no longer serve or mutate resources by relying only on the global request hook.
2026-08-09T10:04:00Z | codex | HARDENING-97 | LOCAL_VERIFICATION | focused archive authorization 11/11, full unit 27 files/106 tests, integration 13 files/41 tests, E2E 3 files/11 tests, and all 16 live-fire proofs passed; typecheck, lint, format, security, and build prerequisites passed.
2026-08-09T10:18:00Z | codex | HARDENING-98 | SECURITY_HARDENING | privacy and billing mutation routes now use shared explicit archive-scope resolution; multi-archive principals must provide archiveId, while single-archive compatibility remains. Current permission and membership checks execute against the selected archive.
2026-08-09T10:20:00Z | codex | HARDENING-98 | LOCAL_VERIFICATION | focused scope authorization 13/13, full unit 27 files/108 tests, integration 13 files/41 tests, E2E 3 files/11 tests, typecheck, lint, formatting, and security gates passed.
2026-08-09T10:22:00Z | codex | HARDENING-98 | LIVE_VERIFICATION | all 16 live-fire proofs passed; performance smoke passed with 100 requests at p95=0.62ms; no external production effect was invoked.
2026-08-09T10:36:00Z | codex | HARDENING-99 | SECURITY_HARDENING | HTTP provider and DeepSeek adapters now cancel non-success response bodies before retrying or surfacing errors, preventing failed upstream streams from retaining connection/buffer resources during outage bursts; no response-size or error contract was weakened.
2026-08-09T10:38:00Z | codex | HARDENING-99 | LOCAL_VERIFICATION | focused provider/DeepSeek tests passed 2 files/9 tests; typecheck, lint, and security-check passed. Full integration and live-fire reruns remain required before checkpoint commit.
2026-08-09T10:41:00Z | codex | HARDENING-99 | FULL_LOCAL_VERIFICATION | unit 27 files/110 tests, integration 13 files/41 tests, E2E 3 files/11 tests, all 16 live-fire proofs, and performance smoke (100 requests, p95=0.66ms) passed; no external production effect invoked.
2026-08-09T10:52:00Z | codex | HARDENING-100 | ACCESSIBILITY_HARDENING | Deterministic PDFs now carry a tagged structure tree, page parent-tree mapping, MCID-marked content, and `/H1`/`/P` structure elements; `/Marked true` is backed by actual structure semantics. EPUB language, heading, navigation, and package metadata remain intact.
2026-08-09T10:54:00Z | codex | HARDENING-100 | FOCUSED_VERIFICATION | Renderer/portable-export tests passed 2 files/6 tests; typecheck, lint, format-check, and security-check passed. Formal PDF/UA and screen-reader audits remain external release evidence.
2026-08-09T10:58:00Z | codex | HARDENING-100 | FULL_LOCAL_VERIFICATION | unit 27 files/110 tests, integration 13 files/41 tests, E2E 3 files/11 tests, all 16 live-fire proofs, performance smoke (100 requests, p95=0.58ms), and workspace production build passed; no external production effect invoked.
2026-08-09T11:03:00Z | codex | HARDENING-101 | VERIFICATION_HARDENING | Added `scripts/accessibility-check.sh` and `tests/accessibility/run.ts`; the deterministic PDF/EPUB structural semantics probe is now wired into `scripts/verify.sh` and CI verification. The gate explicitly remains local structural evidence, not formal PDF/UA approval.
2026-08-09T11:05:00Z | codex | HARDENING-101 | FAILURE_RECOVERY | Initial `pnpm format:check` exited 1 because `tests/accessibility/run.ts` was not Prettier-formatted; the narrow formatter command was applied once, and no code or security gate was weakened.
2026-08-09T11:07:00Z | codex | HARDENING-101 | LOCAL_VERIFICATION | Accessibility probe, format-check, typecheck, lint, security-check, and secret-scan passed after the targeted formatting fix.
2026-08-09T11:12:00Z | codex | HARDENING-101 | FULL_LOCAL_VERIFICATION | unit 27 files/110 tests, integration 13 files/41 tests, E2E 3 files/11 tests, accessibility probe (`pdf_tagged=true epub_semantics=true`), all 16 live-fire proofs, performance smoke (100 requests, p95=0.58ms), and workspace production build passed; no external production effect invoked.
2026-08-09T11:18:00Z | codex | HARDENING-102 | STORAGE_HARDENING | Streamed object fixity verification now enforces an explicit byte ceiling; upload completion passes the authoritative expected session size into `sha256Base64`, preventing a provider/object race from causing unbounded hash reads after HEAD validation.
2026-08-09T11:20:00Z | codex | HARDENING-102 | FAILURE | Direct focused MinIO integration invocation exited 1 for all 3 storage tests with `ECONNREFUSED 127.0.0.1:39000`; the repository intentionally does not publish the internal-only Compose object-storage port.
2026-08-09T11:22:00Z | codex | HARDENING-102 | RECOVERY | The declared internal-network integration runner passed storage 3/3 and the full integration suite 13 files/41 tests; the host-port diagnostic was not treated as a product failure or bypassed.
2026-08-09T11:25:00Z | codex | HARDENING-102 | FULL_LOCAL_VERIFICATION | unit 27 files/110 tests, integration 13 files/41 tests, E2E 3 files/11 tests, accessibility probe, all 16 live-fire proofs, performance smoke (100 requests, p95=0.63ms), and workspace production build passed; no external production effect invoked.
2026-08-09T11:31:00Z | codex | HARDENING-103 | AI_CACHE_HARDENING | Redis AI cache envelopes now have a 16 MiB UTF-8 serialized-size ceiling; oversized reads are evicted before JSON parsing and oversized/non-serializable writes fail before Redis I/O. Regression coverage proves both paths.
2026-08-09T11:36:00Z | codex | HARDENING-103 | FULL_LOCAL_VERIFICATION | focused AI cache 7/7; unit 27 files/111 tests, integration 13 files/41 tests, E2E 3 files/11 tests, accessibility probe, all 16 live-fire proofs, performance smoke (100 requests, p95=1.19ms), and workspace production build passed; no external production effect invoked.
2026-08-09T11:42:00Z | codex | HARDENING-104 | AI_CANONICALIZATION_HARDENING | AI gateway canonical JSON now fails closed on cycles, unsupported JSON values, non-finite numbers, nesting beyond 32 levels, and serialized output above 16 MiB before prompt inspection, cache-key construction, or provider dispatch; regression coverage added.
2026-08-09T11:44:00Z | codex | HARDENING-104 | FAILURE | Combined quality-gate shell invocation exited 124 before output because the wrapper timeout was 14 seconds; no gate result was inferred from the timeout.
2026-08-09T11:46:00Z | codex | HARDENING-104 | RECOVERY | Reran typecheck with a bounded two-minute timeout, then lint, format-check, security-check, and unit suite independently; all passed, with unit 27 files/112 tests.
2026-08-09T11:49:00Z | codex | HARDENING-104 | FAILURE | Declared scripts/verify.sh stopped at the fail-closed preflight with exit 1 and the same 16 unresolved external/legal requirements; no production-readiness pass was inferred.
2026-08-09T11:55:00Z | codex | HARDENING-104 | FULL_LOCAL_VERIFICATION | Independent gates passed: integration 13 files/41 tests, E2E 3 files/11 tests, accessibility (`pdf_tagged=true epub_semantics=true`), workspace build, security, secret scan, dependency audit, reality gate, smoke, all 16 live-fire proofs, and performance smoke (100 requests, p95=0.78ms); unit 27 files/112 tests, typecheck, lint, and format-check also passed. Production readiness remains fail-closed; no external production effect invoked.
2026-08-09T12:02:00Z | codex | HARDENING-105 | TELEMETRY_REDACTION_HARDENING | Telemetry content/secret key matching now normalizes case and separators, and output preserves `__proto__` as inert data via own-property definition; regression coverage added for authorization, API-key, source-text, and special-key variants.
2026-08-09T12:04:00Z | codex | HARDENING-105 | FOCUSED_VERIFICATION | Focused observability suite passed 4/4 after formatting; no secret-shaped fixture was added to tracked source.
2026-08-09T12:10:00Z | codex | HARDENING-105 | FULL_LOCAL_VERIFICATION | Unit 27 files/113 tests, integration 13 files/41 tests, E2E 3 files/11 tests, accessibility (`pdf_tagged=true epub_semantics=true`), workspace build, all 16 live-fire proofs, performance smoke (100 requests, p95=1.05ms), typecheck, lint, format, security, and secret scan passed; production readiness remains fail-closed on the same 16 unresolved requirements.
2026-08-09T12:18:00Z | codex | HARDENING-106 | MFA_INPUT_HARDENING | TOTP enrollment/verification and recovery-code helpers now enforce bounded labels, issuers, secrets, codes, and recovery-hash sets before processing; regression coverage added for oversized inputs.
2026-08-09T12:20:00Z | codex | HARDENING-106 | FOCUSED_VERIFICATION | Focused auth suite passed 10/10; typecheck, lint, format-check, security-check, secret-scan, and full unit suite passed with 27 files/114 tests.
2026-08-09T12:29:00Z | codex | HARDENING-106 | FULL_LOCAL_VERIFICATION | Integration 13 files/41 tests, E2E 3 files/11 tests, accessibility (`pdf_tagged=true epub_semantics=true`), workspace build, all 16 live-fire proofs, performance smoke (100 requests, p95=1.35ms), and production-readiness recheck completed; local gates passed and production readiness remains fail-closed on the same 16 unresolved requirements.
2026-08-09T12:38:00Z | codex | HARDENING-107 | CRYPTO_ENVELOPE_HARDENING | Restricted-text encryption/decryption now bounds plaintext (16 MiB), serialized blobs (32 MiB), base64url components, AES-GCM IV/tag sizes, and decoded ciphertext before crypto processing; regression coverage added for oversized and malformed envelopes.
2026-08-09T12:40:00Z | codex | HARDENING-107 | FOCUSED_VERIFICATION | Focused crypto/auth suite passed 11/11; typecheck, lint, format-check, security-check, secret-scan, and full unit suite passed with 27 files/115 tests.
2026-08-09T12:52:00Z | codex | HARDENING-108 | EXPORT_CANONICALIZATION_HARDENING | Portable export canonicalization now rejects cycles, unsupported values, non-finite numbers, and nesting beyond 32 levels before JSONL serialization and manifest fixity; deterministic object-key ordering is preserved.
2026-08-09T12:53:00Z | codex | HARDENING-108 | FAILURE | Initial focused export regression used a non-record NaN/undefined payload at the zod boundary and exited 1; hypothesis was a test-fixture contract error rather than a canonicalizer failure.
2026-08-09T12:54:00Z | codex | HARDENING-108 | RECOVERY | Replaced the invalid top-level fixtures with valid record payloads containing NaN/undefined values; focused portable-export suite then passed 5/5.
2026-08-09T13:02:00Z | codex | HARDENING-108 | FULL_LOCAL_VERIFICATION | Unit 27 files/116 tests, integration 13 files/41 tests, E2E 3 files/11 tests, accessibility (`pdf_tagged=true epub_semantics=true`), workspace build, all 16 live-fire proofs, performance smoke (100 requests, p95=1.00ms), typecheck, lint, format, security, and secret scan passed; production readiness remains fail-closed on the same 16 unresolved requirements.
2026-08-09T13:18:00Z | codex | HARDENING-109 | PROVENANCE_CANONICALIZATION_HARDENING | Provenance lineage validation now runs before schema cloning and rejects cycles, unsupported values, non-finite numbers, nesting beyond 32 levels, and canonical JSON above 16 MiB before event hashing; forbidden raw-content keys remain blocked.
2026-08-09T13:20:00Z | codex | HARDENING-109 | FOCUSED_VERIFICATION | Focused provenance suite passed 3/3; typecheck, lint, format-check, security-check, secret-scan, and full unit suite passed with 27 files/117 tests.
2026-08-09T13:32:00Z | codex | HARDENING-109 | FULL_LOCAL_VERIFICATION | Unit 27 files/117 tests, integration 13 files/41 tests, E2E 3 files/11 tests, accessibility (`pdf_tagged=true epub_semantics=true`), workspace build, all 16 live-fire proofs, performance smoke (100 requests, p95=0.70ms), typecheck, lint, format, security, and secret scan passed; production readiness remains fail-closed on the same 16 unresolved requirements.
2026-08-09T13:41:00Z | codex | HARDENING-109 | SUPPLEMENTAL_VERIFICATION | Dependency audit, reality gate, smoke test, encrypted backup, and restore rehearsal passed (`schema_migrations=12`); media-tools probe correctly deferred because host binaries `exiftool`, `magick`, `clamscan`, and `ocrmypdf` are unavailable, while the declared internal worker runner remains covered by integration/live-fire evidence.
2026-08-09T14:04:00Z | codex | HARDENING-110 | EVIDENCE_BOUNDARY_HARDENING | Evidence spans now require safe integer offsets and claim evidence is capped at 1,000 spans, preventing unsafe numeric coercion and unbounded validation fan-out.
2026-08-09T14:05:00Z | codex | HARDENING-110 | FOCUSED_VERIFICATION | Focused provenance suite passed 4/4; typecheck, lint, format-check, security-check, secret-scan, and full unit suite passed with 27 files/118 tests.
2026-08-09T14:18:00Z | codex | HARDENING-110 | FULL_LOCAL_VERIFICATION | Unit 27 files/118 tests, integration 13 files/41 tests, E2E 3 files/11 tests, accessibility (`pdf_tagged=true epub_semantics=true`), workspace build, all 16 live-fire proofs, performance smoke (100 requests, p95=2.53ms), typecheck, lint, format, security, and secret scan passed; production readiness remains fail-closed on the same 16 unresolved requirements.
2026-08-09T14:28:00Z | codex | HARDENING-111 | EVIDENCE_CONTRACT_HARDENING | Evidence-link schemas now require safe integer offsets, and `confirmFact` maps invalid evidence links to the domain `VALIDATION_FAILED` contract.
2026-08-09T14:29:00Z | codex | HARDENING-111 | FAILURE | Initial focused and full unit runs failed 1 test because `confirmFact` leaked a ZodError instead of DomainError; hypothesis was a boundary error-mapping defect.
2026-08-09T14:30:00Z | codex | HARDENING-111 | RECOVERY | Replaced direct evidence schema parsing with `safeParse` and explicit `DomainError('VALIDATION_FAILED', ...)`; focused domain suite passed 12/12 and full unit passed 27 files/119 tests.
2026-08-09T14:42:00Z | codex | HARDENING-111 | FULL_LOCAL_VERIFICATION | Unit 27 files/119 tests, integration 13 files/41 tests, E2E 3 files/11 tests, accessibility (`pdf_tagged=true epub_semantics=true`), workspace build, all 16 live-fire proofs, performance smoke (100 requests, p95=2.00ms), typecheck, lint, format, security, and secret scan passed; production readiness remains fail-closed on the same 16 unresolved requirements.
2026-08-09T14:55:00Z | codex | HARDENING-112 | QUOTATION_BOUNDARY_HARDENING | Quotation construction now requires non-negative safe integer source offsets before accepting an approved source span; regression coverage added for unsafe offsets.
2026-08-09T14:57:00Z | codex | HARDENING-112 | FOCUSED_VERIFICATION | Focused domain suite passed 12/12; typecheck, lint, format-check, security-check, secret-scan, and full unit suite passed with 27 files/119 tests.
2026-08-09T15:10:00Z | codex | HARDENING-112 | FULL_LOCAL_VERIFICATION | Unit 27 files/119 tests, integration 13 files/41 tests, E2E 3 files/11 tests, accessibility (`pdf_tagged=true epub_semantics=true`), workspace build, all 16 live-fire proofs, performance smoke (100 requests, p95=1.55ms), typecheck, lint, format, security, and secret scan passed; production readiness remains fail-closed on the same 16 unresolved requirements.
2026-08-09T15:24:00Z | codex | HARDENING-113 | DOMAIN_EVIDENCE_GRAPH_HARDENING | Generated revisions and disputed claims now validate each evidence link and cap claims, dispute accounts, and per-item evidence at 1,000 entries; factual generated claims still require evidence.
2026-08-09T15:25:00Z | codex | HARDENING-113 | FAILURE | Initial focused and static runs failed because `Array.isArray` narrowed typed claim collections to `any[]`, producing TypeScript and ESLint unsafe-any errors; no behavior was accepted from that run.
2026-08-09T15:26:00Z | codex | HARDENING-113 | RECOVERY | Removed redundant runtime array guards from statically typed collections while retaining count and schema validation; focused domain suite passed 13/13 and full unit passed 27 files/120 tests.
2026-08-09T15:40:00Z | codex | HARDENING-113 | FULL_LOCAL_VERIFICATION | Unit 27 files/120 tests, integration 13 files/41 tests, E2E 3 files/11 tests, accessibility (`pdf_tagged=true epub_semantics=true`), workspace build, all 16 live-fire proofs, performance smoke (100 requests, p95=0.62ms), typecheck, lint, format, security, and secret scan passed; production readiness remains fail-closed on the same 16 unresolved requirements.
2026-08-09T15:55:00Z | codex | HARDENING-114 | ANNOTATION_PROVENANCE_HARDENING | Annotated candidate extraction now caps fan-out at 1,000 records and evidence assertion validates candidate UUIDs, known kinds, safe source offsets, and exact marker kind/value fidelity against source text.
2026-08-09T15:56:00Z | codex | HARDENING-114 | FOCUSED_VERIFICATION | Focused annotation provenance suite passed 2/2; typecheck, lint, format-check, security-check, secret-scan, and full unit passed with 27 files/121 tests.
2026-08-09T16:02:00Z | codex | HARDENING-114 | FULL_LOCAL_VERIFICATION | Unit 27 files/121 tests, integration 13 files/41 tests, E2E 3 files/11 tests, accessibility (`pdf_tagged=true epub_semantics=true`), workspace build, all 16 live-fire proofs, performance smoke (100 requests, p95=1.51ms), typecheck, lint, format, security, and secret scan passed; production readiness remains fail-closed on the same 16 unresolved requirements.
