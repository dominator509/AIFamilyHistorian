...
| INV-012 | Open documented export formats prevent platform lock-in. | IMPLEMENTED | PENDING | Portable JSONL/CSV manifests plus deterministic PDF/EPUB renderers pass local live-fire; archive restore and accessibility audit remain. |
