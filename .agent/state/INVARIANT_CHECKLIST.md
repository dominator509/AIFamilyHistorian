...
| INV-012 | Open documented export formats prevent platform lock-in. | IMPLEMENTED | VERIFIED | Publication bundle emits deterministic JSONL/CSV/PDF/EPUB artifacts and portable manifests; local backup restore passes, while formal accessibility audit remains. |
