...
- Disposable internal-network integration runner -> 12 files, 36 tests passed, with real PostgreSQL, Redis, MinIO, SMTP, and telemetry service endpoints; migrations and `.env` were mounted read-only and the worker network boundary was not changed.
