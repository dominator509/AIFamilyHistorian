...
- `sh scripts/restore-check.sh .artifacts/backups/family-historian-20260808T123037Z.dump.enc` -> `restore-check: ok`; the encrypted backup decrypted into a disposable database and reported `schema_migrations=11`.
